      ...
      <div className={`h-[280px] sm:h-[320px] w-full rounded-[24px] ${bgGradient} shadow-xl shine-effect`}>
        <div className="flex h-full flex-col justify-between p-6 sm:p-8 lg:p-10">
          ...
          <div className="flex flex-1 flex-col items-center justify-center gap-2">
            <h1 className="text-4xl sm:text-5xl font-bold tracking-tight lg:text-7xl text-center">{title}</h1>
            <p className="text-lg sm:text-xl font-medium lg:text-2xl text-center">{subtitle}</p>
          </div>
        </div>
      </div>
